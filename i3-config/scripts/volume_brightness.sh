...
function show_volume_notif {
    volume=$(get_mute)
    get_volume_icon
    #notify-send -i audio-volume-muted -t 1000 "$volume_icon $volume%" -h int:value:$volume -h string:x-canonical-private-synchronous:volume
    notify-send -i none  -t 1000 "$volume_icon $volume%" -h int:value:$volume -h string:x-canonical-private-synchronous:volume
}
